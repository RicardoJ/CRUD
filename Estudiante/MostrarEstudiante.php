...
<h1>Consultar</h1>
<form name="form1" method="post"  action="../Estudiante/MostrarEstudiante.php" onsubmit ="return validar();">
...
if(isset($_POST['consultar'])){
	$id = $_POST["id"];
$resultado= mysql_query("SELECT * FROM `estudiante` WHERE ID_E = $id ",$con);
while($consulta = mysql_fetch_array($resultado)){
	...
	<tr>
		<td>".$consulta['NombreE']."</td>
		<td>".$consulta['ApellidoE']."</td>
		<td>".$consulta['GeneroE']."</td>
